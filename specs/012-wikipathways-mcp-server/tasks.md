...
> Note (2026-09-03, after baseline converge): T097 conflicts with ADR-007 §2 as written: rate limiting belongs in `LifeSciencesClient` once (AGE-698), not as another per-client `_rate_limited_get`. Implement via the base client.
